...
- http://presentations.cocodataset.org/COCO17-Stuff-FAIR.pdf - A Unified Architecture for Instance and Semantic Segmentation
...
class FPNSeg(nn.Module):
    ...
    def forward(self, x):
        ...
        return nn.functional.upsample(final, scale_factor=4, mode="nearest")
